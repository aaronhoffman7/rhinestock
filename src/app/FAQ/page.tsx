...
<p>
  ...
  <a href="https://www.amtrak.com/tickets/departure.html" target="_blank" rel="noopener noreferrer"> Amtrak</a> from NYC Penn Station to Rhinecliff or <a href="https://new.mta.info/schedules/metro-north-railroad" target="_blank" rel="noopener noreferrer">
    Metro North</a> from Grand Central Station to Poughkeepsie. From either train station you&apos;ll need to get a car to the house. Ubers are still very spotty in the area so we recommend having someone pick you up from the house or use one of these local cab services
</p>
  </section>
